...
class getSecrets_VaultService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('/Users/simonmhretab/Documents/Habesha-tools/habesha/config/secrets/'.$container->getEnv('string:default:kernel.environment:APP_RUNTIME_ENV'), \Symfony\Component\String\LazyString::fromCallable($container->getEnv(...), 'base64:default::SYMFONY_DECRYPTION_SECRET'));
    }
}
