...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(['/Users/simonmhretab/Documents/Habesha-tools/habesha/vendor/vich/uploader-bundle/config/doctrine' => 'Vich\\UploaderBundle\\Entity'], '.orm.xml', true);
        $c->setGlobalBasename('mapping');

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['/Users/simonmhretab/Documents/Habesha-tools/habesha/src/Entity'], true), 'App\\Entity');
