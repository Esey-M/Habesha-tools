...
class getConsole_Command_DotenvDebugService extends App_KernelProdContainer
{
    ...
    {
        $container->privates['console.command.dotenv_debug'] = $instance = new \Symfony\Component\Dotenv\Command\DebugCommand('prod', '/Users/simonmhretab/Documents/Habesha-tools/habesha');
