...
class getQuestionRepositoryService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['App\\Repository\\QuestionRepository'] = new \App\Repository\QuestionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
