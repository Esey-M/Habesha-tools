...
class getMonolog_Handler_DeprecationService extends App_KernelProdContainer
{
    ...
    {
        $container->privates['monolog.handler.deprecation'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 5).'//Users/simonmhretab/Documents/Habesha-tools/habesha/var/log/prod.deprecations.log'), 'DEBUG', true, NULL, false);
