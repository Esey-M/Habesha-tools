...
class App_KernelProdContainer extends Container
{
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), \dirname(__DIR__, 6), false);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'KnpTimeBundle' => [
                    'path' => (\dirname(__DIR__, 6).'/vendor/knplabs/knp-time-bundle'),
                    'namespace' => 'Knp\\Bundle\\TimeBundle',
                ],
                'TwigComponentBundle' => [
                    'path' => (\dirname(__DIR__, 6).'/vendor/symfony/ux-twig-component'),
            ...
            'upload_directory' => (\dirname(__DIR__, 5).'/uploads/images'),
            'python_script_path' => (\dirname(__DIR__, 6).'/scripts/remove_background.py'),
            'python_script_path_logo' => (\dirname(__DIR__, 6).'/scripts/remove_logo.py'),
            'python_path' => (\dirname(__DIR__, 6).'/venv/bin/python3'),
            'app.upload_directory' => (\dirname(__DIR__, 5).'/uploads/images'),
            'app.python_script_path' => (\dirname(__DIR__, 6).'/scripts/remove_background.py'),
            'logo_removal_script_path' => (\dirname(__DIR__, 6).'/scripts/remove_logo.py'),
            'cache_directory' => (\dirname(__DIR__, 6).'/var/cache'),
            ...
            'vich_uploader.mappings' => [
                'images' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 5).'/uploads/images'),
                    'namer' => [
