...
class getUx_TwigComponent_Command_DebugService extends App_KernelProdContainer
{
    ...
    {
        $container->privates['ux.twig_component.command.debug'] = $instance = new \Symfony\UX\TwigComponent\Command\TwigComponentDebugCommand((\dirname(__DIR__, 6).'/templates'), ($container->privates['ux.twig_component.component_factory'] ?? $container->load('getUx_TwigComponent_ComponentFactoryService')), ($container->privates['twig'] ?? $container->load('getTwigService')), [], 'components/');
